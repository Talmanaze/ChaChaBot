...
exports.run = (client, connection, message, args) => {
  ...
  var catchDC = Math.round(0.15 * (255 - catchrate) + 1.55 + dexmod);
  ...
  message.channel.send(
    `The DC to catch ${name} is ${catchDC}. The DC to put a loop around ${name} is ${loopDC}.\n\nDon't forget, a Nat 1 is an auto-fail, and a Nat 20 is an auto-success.`
  );
};
